  ...
  return (
    <div className="relative">
      ...
      >
        ...
        {/* Email */}
        <span className="block mr-1 font-medium text-sm">{user.email}</span>
      ...
      >
        ...
        <div className="mt-4 pt-3 border-t border-gray-200 dark:border-gray-700">
          <DropdownItem
            ...
            className="flex items-center gap-3 px-3 py-2 w-full font-medium text-gray-700 rounded-lg group text-sm hover:bg-gray-100 hover:text-gray-700 dark:text-gray-400 dark:hover:bg-white/5 dark:hover:text-gray-300"
          >
            <svg
